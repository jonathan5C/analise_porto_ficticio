# 📊 Análise dados de Descargas no Porto

Dados fictícios, gerados pelo Claude, de entregas dentro de um porto fictício. Projeto para aperfeiçoar os conhecimentos usando tecnologias para análise de dados.
...
`DataFrame` · `merge` · `groupby` · `sort_values` · `filter` · `barplot` · `concat`

---

## Analises estatisticas

> Durante o ano de 2025, qual tipo descarregou no porto?
